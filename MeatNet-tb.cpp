...
int main(){
    ...
    for(int cut=0;cut<12;cut++){
        ...
        FILE *fparam;
        sprintf(directory, "/home/daniel/Carnes/%s/quant/params.txt", cut_names[cut]);
        ...
        FILE *fout;
        sprintf(directory, "/home/daniel/Carnes/%s/quant/%d-%d.txt", cut_names[cut], total_apfixed, int_apfixed);
